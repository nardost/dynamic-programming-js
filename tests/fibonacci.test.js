...
describe('Fibonacci numbers with dynamic programming', () => {
    ...
    test.skip.each([40, 50, 60, 70, 75, 78])('The %sth Fibonacci number is less than or equal to ' + Number.MAX_SAFE_INTEGER, (a) => {
        expect(dynamicFib(a)).toBeLessThanOrEqual(Number.MAX_SAFE_INTEGER);
    }),
    test.skip.each([79, 80, 90])('The %sth Fibonacci number is greater than ' + Number.MAX_SAFE_INTEGER, (a) => {
